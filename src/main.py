...
if __name__== "__main__":
    ...
    parser.add_argument('--modelPath', default='model_backup/epoch110_2Dresnet_skullstrip_MNI_subject5Class.pt')
    parser.add_argument('--outputPath', default='reconstructed_2')
    ...
    for i in range(len(fileName)):
        ...
        #correct, total, TP, FP, FN = diceScore7slice(fileName[i],finalimg,gtPath,maxPos[2])

        #with open('dicescore.txt',"a+") as file:
        #    file.write('{}: {}\n'.format(fileName[i],correct/total*100))
